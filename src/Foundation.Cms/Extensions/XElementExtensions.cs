...
namespace Foundation.Cms.Extensions
{
    public static class XElementExtensions
    {
        ...
        public static bool GetBoolOrDefault(this XElement xElement, string elementName) => bool.TryParse((string)xElement.Element(elementName), out var value) ? value : false;
        ...
        public static decimal GetDecimalOrDefault(this XElement xElement, string elementName) => decimal.TryParse((string)xElement.Element(elementName), NumberStyles.Float, CultureInfo.InvariantCulture, out var parsedValue) ? parsedValue : 0;

        public static double GetDoubleOrDefault(this XElement xElement, string elementName) => double.TryParse((string)xElement.Element(elementName), NumberStyles.Float, CultureInfo.InvariantCulture, out var value) ? value : 0;
