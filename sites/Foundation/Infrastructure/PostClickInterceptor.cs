...
namespace Foundation.Infrastructure
{
    ...
    public class PostClickInterceptor : ITrackingDataInterceptor
    {
        ...
        {
            if (_isConfigured && ShouldSendPostClick(trackingData))
            {
        ...
        {
            if (trackingData is TrackingData<EpiPageViewWrapper> pageView)
            {
        ...
        {
            if (trackingData is TrackingData<CommerceTrackingData> productView)
            {
        ...
        {
            if (trackingData is TrackingData<CommerceTrackingData> orderEvent)
            {
        ...
        {
            if (trackingData is TrackingData<CommerceTrackingData> categoryView)
            {
        ...
        {
            if (trackingData is TrackingData<CommerceTrackingData> basketEvent)
            {
