...
namespace Foundation.Features.MyOrganization.QuickOrderBlock
{
    ...
    public class QuickOrderBlockController : BlockController<Commerce.Models.Blocks.QuickOrderBlock>
    {
        ...
        [HttpGet]
        public override ActionResult Index(Commerce.Models.Blocks.QuickOrderBlock currentContent)
        {
            currentContent.ReturnedMessages = TempData["messages"] as List<string>;
            currentContent.ProductsList = TempData["products"] as List<ProductViewModel>;
        ...
        private Commerce.Models.Pages.QuickOrderPage GetQuickOrderPage() => _contentLocator.FindPagesRecursively<Commerce.Models.Pages.QuickOrderPage>(ContentReference.StartPage).FirstOrDefault();
