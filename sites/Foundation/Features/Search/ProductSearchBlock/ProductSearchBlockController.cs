...
namespace Foundation.Features.Search.ProductSearchBlock
{
    ...
    public class ProductSearchBlockController : BlockController<Commerce.Models.Blocks.ProductSearchBlock>
    {
        ...
        [HttpGet]
        public override ActionResult Index(Commerce.Models.Blocks.ProductSearchBlock currentContent)
        {
            ...
            try
            {
                result = GetSearchResults(currentContent);
            }
            ...
            SortProducts(currentContent, result);

            MergePriorityProducts(currentContent, result);

            HandleDiscontinuedProducts(currentContent, result);
            ...
            var productSearchResult = new ProductSearchResultViewModel(currentContent)
            {
                Heading = currentContent.Heading,
                ItemsPerRow = currentContent.ItemsPerRow,
        ...
        private ProductSearchResults GetSearchResults(Commerce.Models.Blocks.ProductSearchBlock productSearchBlock)
        {
