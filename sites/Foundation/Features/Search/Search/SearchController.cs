...
#pragma warning restore VSTHRD200 // Use "Async" suffix for async methods
        {
            ...
            else
            {
                ...
                {
                    var trackingResult =
                        await _recommendationService.TrackSearchAsync(HttpContext, filterOptions.Q, filterOptions.PageSize,
            ...
            await _cmsTrackingService.SearchedKeywordAsync(_httpContextBase, filterOptions.Q);
...
#pragma warning restore CA5363 // Do Not Disable Request Validation
        ...
        [ChildActionOnly]
        public ActionResult Facet(CommerceFilterOptionViewModel viewModel) => PartialView("_Facet", viewModel);
