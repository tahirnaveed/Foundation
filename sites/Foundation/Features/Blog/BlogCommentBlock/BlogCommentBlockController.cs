...
namespace Foundation.Features.Blog.BlogCommentBlock
{
    ...
    public class BlogCommentBlockController : BlockController<Cms.Blocks.BlogCommentBlock>
    {
        ...
        [HttpGet]
        public override ActionResult Index(Cms.Blocks.BlogCommentBlock currentContent)
        {
            var pagingInfo = new PagingInfo(_pageRouteHelper.PageLink.ID, currentContent.CommentsPerPage == 0 ? RecordPerPage : currentContent.CommentsPerPage, 1);
