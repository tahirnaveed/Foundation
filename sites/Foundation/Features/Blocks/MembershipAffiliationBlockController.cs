...
namespace Foundation.Features.Blocks
{
    ...
    public class MembershipAffiliationBlockController : SocialBlockController<MembershipAffiliationBlock>
    {
        ...
        [HttpGet]
        public override ActionResult Index(MembershipAffiliationBlock currentContent)
        {
            //Populate model to pass to the membership affiliation view
            var membershipAffiliationBlockModel = new MembershipAffiliationBlockViewModel(currentContent);
