...
namespace Foundation.Features.Blocks
{
    ...
    public class CommentsBlockController : SocialBlockController<CommentsBlock>
    {
        ...
        [HttpGet]
        public override ActionResult Index(CommentsBlock currentContent)
        {
            ...
            var blockViewModel = new CommentsBlockViewModel(currentContent, pageReference)
            {
            ...
            try
            {
                var socialComments = this._commentRepository.Get(
                    new PageCommentFilter
                    {
                        ...
                        PageSize = currentContent.CommentsDisplayMax
                    }
                );
