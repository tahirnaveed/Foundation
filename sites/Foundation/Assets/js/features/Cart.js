                ...
                if (!isNaN(valueInt) && Number.isInteger(valueInt)) {
                    ...
                    if (valueInt > 0)
                        ...
                        if (confirm("Are you sure delete this item?")) {
                            ...
                            inst.removeItem('/defaultcart/RemoveCartItemAsync', elementDelete, "large-cart");
                        }
                    }
                }
                else {
        ...
        $(selector).find('.jsRemoveCartItem').each(function (i, e) {
            $(e).click(function () {
                if (confirm("Are you sure?")) {
                    ...
                    var url = "/defaultcart/RemoveCartItemAsync";
                    //var typeCart = "#js-cart";
                    if (type === "wishlist") {
                        url = "/wishlist/RemoveWishlistItemAsync";
                        //typeCart = "#js-wishlist";
                    }

                    if (type === "large-cart") {
                        url = "/defaultcart/RemoveCartItemAsync";
                        //typeCart = "#cartItemsId";
                    }

                    if (type === "shared-cart") {
                        url = "/sharedcart/RemoveCartItemAsync";
